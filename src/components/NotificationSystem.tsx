...
export function NotificationSystem() {
  ...
  useEffect(() => {
    ...
    const checkGoals = () => {
      const dailyGoal = goalStorage.getActiveDailyGoal();
      if (dailyGoal) {
  ...
  useEffect(() => {
    ...
    const checkReminders = () => {
      const remindersToNotify = reminderStorage.getRemindersToNotify();
      ...
      remindersToNotify.forEach(reminder => {
        ...
        reminderStorage.markAsNotified(reminder.id);
      });
    };
  ...
  useEffect(() => {
    ...
    const remindBreak = () => {
      const runningEntry = timeEntryStorage.getAll().find(e => e.isRunning);
      if (runningEntry) {
